  ...
  <section id="dashboard-ecommerce">
        ...
        <div class="col-lg-2 col-sm-6 col-12">
          <div class="card">
              <div class="card-header d-flex flex-column align-items-start pb-0">
                  ...
                  <h2 class="text-bold-700 mt-1">2.500</h2>
      ...
      <div class="col-lg-2 col-sm-6 col-12">
          <div class="card">
              <div class="card-header d-flex flex-column align-items-start pb-0">
                  ...
                  <h2 class="text-bold-700 mt-1">123.50</h2>
                  <p class="mb-0">Total Month </p>
              </div>
              <div class="card-content">
      ...
      <div class="col-lg-2 col-sm-6 col-12">
          <div class="card">
              <div class="card-header d-flex flex-column align-items-start pb-0">
                  ...
                  <h2 class="text-bold-700 mt-1">4.567</h2>
                  <p class="mb-0">Top IP Source</p>
              </div>
              <div class="card-content">
      ...
      <div class="col-lg-2 col-sm-6 col-12">
          <div class="card">
              <div class="card-header d-flex flex-column align-items-start pb-0">
                  ...
                  <h2 class="text-bold-700 mt-1">2.315</h2>
                  <p class="mb-0">Top IP Dest...</p>
              </div>
          </div>
      </div>
      <div class="col-lg-2 col-sm-6 col-12">
          <div class="card">
              <div class="card-header d-flex flex-column align-items-start pb-0">
                  ...
                  <h2 class="text-bold-700 mt-1">7.235</h2>
                  <p class="mb-0">Top Signature</p>
              </div>
          </div>
      </div>
  </div>
      ...
      <div class="row">
          <div class="col-lg-8 col-md-6 col-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-end">
                  <h4 class="card-title">All Events - Last 12 hours </h4>
              </div>
              <div class="card-content">
                  <div class="card-body pb-0">
                      <div class="d-flex justify-content-start">
                          <p>All Events in Last 12 hours (last update: a few seconds ago)</p>
                      </div>
          ...
          <div class="col-lg-4 col-md-6 col-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-end">
                  <h4 class="mb-0">Firewall Events by Type</h4>
                  ...
                  <div class="card-body px-0 pb-0">
                      ...
                      <div class="row text-center mx-0">
                          <div class="col-6 border-top border-right d-flex align-items-between flex-column py-1">
                              <p class="mb-50">Web Traffic Audit</p>
                              <p class="font-large-1 text-bold-700">786,617</p>
                          </div>
                          <div class="col-6 border-top d-flex align-items-between flex-column py-1">
                              <p class="mb-50">TCP Traffic Audit</p>
      ...
      <div class="row">
        <div class="col-md-4 col-12">
          <div class="card">
            <div class="card-header">
                <h4 class="card-title">Logon Failures by User</h4>
            </div>
            <div class="card-content">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-25">
                        <div class="browser-info">
                            <p class="mb-25">billybob</p>
                            <h4>73%</h4>
                        </div>
        ...
        <div class="col-md-8 col-12">
          <div class="card">
            <div class="card-header">
                <h4 class="card-title">Traffic by Destination Port</h4>
            </div>
            <div class="card-content">
                <div class="card-body">
                    <p>All Network Traffic by DestinationPort </p>
      ...
      <div class="row">
        <div class="col-lg-4 col-12">
          <div class="card">
            <div class="card-header d-flex justify-content-between align-items-end">
                <h4>Logon Failures by Source Device</h4>
        ...
        <div class="col-lg-4 col-12">
          <div class="card">
            <div class="card-header d-flex justify-content-between pb-0">
                <h4 class="card-title">All Events by Connector Name</h4>
                <!-- <div class="dropdown chart-dropdown">
